...
async function main() {
  ...
  console.log(`npx hardhat verify --network <network> ${zkIdVerifierAddress} ${ageVerifierAddress} ${nationalityVerifierAddress} ${ageVerifierSignedAddress} ${nationalityVerifierSignedAddress} ${ageVerifierRevocableAddress}`);
}
